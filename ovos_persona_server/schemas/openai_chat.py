...
class CreateChatCompletionRequest(BaseModel):
    ...
    model: Optional[str] = Field(..., description="ID of the model to use. See the [model endpoint compatibility](/docs/models/model-endpoint-compatibility) table for details on which models work with the Chat API.")
...
class CreateChatCompletionResponse(BaseModel):
    ...
    model: Optional[str] = Field(..., description="The model used for the chat completion.")
...
class CreateCompletionRequest(BaseModel):
    ...
    """
    model: Optional[str] = Field(..., description="ID of the model to use. You can use the [List models](/docs/api-reference/models/list) API to see all of your available models, or see our [Model overview](/docs/models/overview) for descriptions of them.")
...
class CreateCompletionResponse(BaseModel):
    ...
    model: Optional[str] = Field(..., description="The model used for completion.")
    choices: List[
        Dict[str, Any]
