...
class CreateChatCompletionRequest(BaseModel):
    ...
    model: Optional[str] = Field(default=None, description="ID of the model to use — the name of a persona served by this process. Optional: when omitted the default persona answers. See the [model endpoint compatibility](/docs/models/model-endpoint-compatibility) table for details on which models work with the Chat API.")
...
class CreateCompletionRequest(BaseModel):
    ...
    """
    model: Optional[str] = Field(default=None, description="ID of the model to use — the name of a persona served by this process. Optional: when omitted the default persona answers. You can use the [List models](/docs/api-reference/models/list) API to see all of your available models.")
